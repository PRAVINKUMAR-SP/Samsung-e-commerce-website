...
export default function Auth() {
  ...
  const register = async () => {
    ...
    try {
      const response = await fetch("https://samsung-backend-xds3.onrender.com/api/auth/register", {
        method: "POST",
        headers: {
  ...
  const login = async () => {
    ...
    try {
      const response = await fetch("https://samsung-backend-xds3.onrender.com/api/auth/login", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
